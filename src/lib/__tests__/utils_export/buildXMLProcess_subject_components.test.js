...
import { monograph_subject_simple, monograph_subject_simple_simple_sub, monograph_subject_personal_name, monograph_subject_geo, monograph_subject_hub, monograph_subject_complex } from './xml/monograph_subject_simple.json'
