...
const utilsNetwork = {
    ...
    */
    fetchContextData: async function(uri){
          ...
          if (returnUrls.dev){
            jsonuri = jsonuri.replace('https://id.loc.gov/','https://preprod-8288.id.loc.gov/')
            jsonuri = jsonuri.replace('http://id.loc.gov/','https://preprod-8288.id.loc.gov/')

            console.log("jsonurijsonurijsonurijsonurijsonurijsonurijsonuri",jsonuri)
