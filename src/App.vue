...
export default {
  ...
  computed: {
    ...
    ...mapWritableState(useProfileStore, ['showShelfListingModal','showHubStubCreateModal', 'showAutoDeweyModal', 'showNacoStubCreateModal', 'showMarvaLogModal', 'showUserDirectoryModal', 'showFolioSyncModal']),
