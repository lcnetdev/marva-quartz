...
test('Able to add an edited subject', async ({ page }) => {
    ...
    await expect(page.getByRole('dialog')).toContainText('Public schools (Auth Hd) public');
