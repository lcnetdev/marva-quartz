...
test('Basic NAF Search and Add Monograph Profile', async ({ page }) => {
  ...
  await page.getByRole('group').getByRole('button', { name: 'Monograph' }).click();
  ...
  await expect(page.locator('[id="edit_lc\\:RT\\:bf2\\:Monograph\\:Work_id_loc_gov_ontologies_bibframe_contribution__creator_of_work"]')).toContainText('Smith, A. (Alan), 1931-');
